...
public class TradeSrcPathDialog extends TitleAreaDialog
{
     ...
     * @param parentShell
     */
    public TradeSrcPathDialog(Shell parentShell, Object obj, String string, String prjId) {
        super(parentShell);
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        tradeSrcPathText.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
        ...
        tradeSrcPathList = new List(container, SWT.BORDER | SWT.H_SCROLL | SWT.V_SCROLL | SWT.MULTI);
        tradeSrcPathList.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 3));
        ...
        tradeSrcPathText.addKeyListener(new KeyAdapter()
        {
            ...
            public void keyPressed(KeyEvent e)
            {
                if ((tradeSrcPathText.getText().trim().isEmpty() == false)
                        && (e.keyCode == SWT.CR))
                {
                    tradeSrcPathList.add(tradeSrcPathText
                            .getText());
        ...
        upButton.addSelectionListener(new SelectionAdapter()
        {
            ...
            public void widgetSelected(SelectionEvent e)
            {
                ...
                if(index > 0)
                {
                    ...
                    tradeSrcPathList.setItem(index, tradeSrcPathList.getItem(index-1));
