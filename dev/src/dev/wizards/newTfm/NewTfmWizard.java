...
public class NewTfmWizard extends Wizard implements INewWizard
{
    ...
    private void getData()
    {
        ...
        {
            bindingTradeId = Integer.parseInt(page0.getBindingTradeIdText().getText());
        }
        tfmType = Integer.parseInt(page0.getTfmTypeCombo().getText().substring(
                0, 1));
     ...
     * 
     * @param tfmId 流程图的ID
     * @param tfmName 流程图的名称
     * @param tfmDesc 流程图的描述
     * @param tfmType 流程图的类型
     * @param bindingTradeId 流程图所绑定的交易ID
     * @throws SQLException
     */
    ...
    private void updateNavView()
    {
        ...
        if (view != null)
        {
            ...
            {
                if (root.getChildren().get(index).getName().equals(tfmUpProject))
                {
                    break;
                }
            }
