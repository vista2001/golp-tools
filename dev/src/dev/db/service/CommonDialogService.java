...
public interface CommonDialogService {
	...
	/**
	 * 查询某特定工程的服务程序表中的所有记录，一条记录对应一个TServer对象，所有数据项记录将以 List&ltTServer&gt的形式返回。
	 * 
	 * @param prjId
	 *            特定工程的工程Id
	...
	/**
	 * 查询某特定工程的交易表中的所有记录，一条记录对应一个TTrade对象，所有数据项记录将以 List&ltTTrade&gt的形式返回。
	 * 
	 * @param prjId
	 *            特定工程的工程Id
	 * @param type
	 *            查询的类型，若为Constants.ALL，则表示查询所有的交易，若为Constants.TFM_BINDING，
	 ...
	 * @throws SQLException
	 */
	public void updateDataItemState(String prjId, String[] published,
			String[] nonPublished) throws SQLException;
}
