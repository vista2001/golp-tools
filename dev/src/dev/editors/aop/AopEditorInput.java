...
/**
 * Aop表编辑器的Input类
 * <p>这个类实现了IEditorInput接口，与AopEditor类一起完成Aop编辑器的功能<br>
 * 在编辑器的初始化的时候，将AopEditor类完成编辑器的初始化所需要的数据传入，并在编辑器
 * 存在的时候保存编辑器的配置信息。
 * @see#getName()
 * @see#getToolTipText()
 * @see#setName()
...
public class AopEditorInput implements IEditorInput {
	...
	public boolean equals(Object obj) {
		  ...
		  if(!node.getRootProject().equals(((AopEditorInput)obj).getSource().getRootProject())) return false;
