...
public class OthFunSourceDialog extends TitleAreaDialog
{
	...
	protected Control createDialogArea(Composite parent) {
		...
		othFunSourceList = new List(container, SWT.BORDER | SWT.V_SCROLL | SWT.MULTI);
		othFunSourceList.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 4));
		...
		addButton.addSelectionListener(new SelectionAdapter()
		{
			...
			public void widgetSelected(SelectionEvent e)
			{
				...
				for (String s : files)
				{
						...
						{
							othFunSourceList.add(dialog.getFilterPath() + s);
						}
						//othFunSourceList.add(dialog.getFilterPath() + s);
					else
						othFunSourceList.add(dialog.getFilterPath() + File.separator + s);
				}
			}
		});
