...
public class ServerSpecObjDialog extends TitleAreaDialog
{
     ...
     * @param parentShell
     */
    public ServerSpecObjDialog(Shell parentShell, Object obj, String string, String prjId) {
        super(parentShell);
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        serverSpecObjText.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
        ...
        serverSpecObjList = new List(container, SWT.BORDER | SWT.H_SCROLL | SWT.V_SCROLL | SWT.MULTI);
        serverSpecObjList.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 3));
        ...
        serverSpecObjText.addKeyListener(new KeyAdapter()
        {
            ...
            public void keyPressed(KeyEvent e)
            {
                if ((serverSpecObjText.getText().trim().isEmpty() == false)
                        && (e.keyCode == SWT.CR))
                {
                    serverSpecObjList.add(serverSpecObjText
                            .getText());
        ...
        upButton.addSelectionListener(new SelectionAdapter()
        {
            ...
            public void widgetSelected(SelectionEvent e)
            {
                ...
                if(index > 0)
                {
                    ...
                    serverSpecObjList.setItem(index, serverSpecObjList.getItem(index-1));
