...
public class RetCodeEditorInput implements IEditorInput{
	...
	/**根据编辑器的标识判断一个节点的编辑器是不是打开了了*/
	 public boolean equals(Object obj) {
	  ...
	  if(!(obj instanceof RetCodeEditorInput)) return false;
	   
	  if(!getName().equals(((RetCodeEditorInput)obj).getName())) return false;
	  
	  if(!node.getRootProject().equals(((RetCodeEditorInput)obj).getSource().getRootProject())) return false;
